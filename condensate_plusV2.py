...
def get_weather_data(api_key, latitude, longitude):
    ...
    if response.status_code == 200:
        temperature_celsius = data["main"]["temp"] - 273.15  # Convert Kelvin to Celsius
...
def main():
    ...
    while True:
        ...
        if weather_data:
            temperature_celsius, humidity = weather_data
            ...
            print(f"Current Temperature: {temperature_fahrenheit:.1f}°F")
            ...
            with open(csv_file, mode='a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([temperature_fahrenheit, humidity, condensate_production])
